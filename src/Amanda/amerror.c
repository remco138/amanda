...
#define maxparsewarningmessage 9 //random

static char *parsewarningmessage[maxparsewarningmessage+1] =
{
  "empty list generator"
};
  
void parsewarning(int messagenr)
{
  error(parsewarningmessage[messagenr]);
}
